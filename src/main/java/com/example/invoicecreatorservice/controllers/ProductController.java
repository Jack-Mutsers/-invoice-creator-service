...
public class ProductController {
    ...
    @PostMapping(path="")
    public @ResponseBody ResponseEntity<ProductDTO> createProduct(@RequestBody ProductForCreationDTO product) {
    ...
    @PutMapping(path ="/{id}")
    public @ResponseBody ResponseEntity updateProduct(@PathVariable int id, @RequestBody ProductForUpdateDTO product) {
