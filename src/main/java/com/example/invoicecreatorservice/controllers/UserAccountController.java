...
public class UserAccountController {
    ...
    public @ResponseBody ResponseEntity<UserAccountDTO> login(@RequestBody UserAccountForCreationDTO account) {
    ...
    public @ResponseBody ResponseEntity deleteUser(@PathVariable int id, @RequestBody UserAccountForDeletionDTO account) {
    ...
    @PostMapping(path="")
    public @ResponseBody ResponseEntity<UserAccountDTO> createUserAccount(@RequestBody UserAccountForCreationDTO user) throws Exception {
    ...
    @PutMapping(path ="/{id}")
    public @ResponseBody ResponseEntity updateUserAccount(@PathVariable int id, @RequestBody UserAccountForUpdateDTO account) {
